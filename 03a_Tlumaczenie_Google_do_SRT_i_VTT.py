...
def translate_file(file_path, src_lang='pl', dest_lang='en'):
    try:
...
def translate_files_in_directory(directory, src_lang='pl', dest_lang='en'):
...
source_directory = r'E:\XBLD_Adobe'
