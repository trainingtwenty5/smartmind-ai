...
def process_video(input_video, srt_file, vtt_file, threshold=0.85):
    ...
    result = model.transcribe(input_video, language="fr")  # Ustawienie języka na francuski
    segments = result["segments"]
    nlp = spacy.load("fr_core_news_sm")  # SpaCy dla języka francuskiego
...
if __name__ == "__main__":
    input_folder = r"E:\fr_p_2"  # Folder with input MP4 files
